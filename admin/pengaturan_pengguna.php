                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                      ...
                                      $datad = mysqli_query($koneksi,"select count(id) as jumlah from user ");
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                      include "koneksi.php";
                                      $no=1;
                                      $datad = mysqli_query($koneksi,"select * from user");
                                        while($data = mysqli_fetch_array($datad)){
